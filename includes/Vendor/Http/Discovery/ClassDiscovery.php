...
use OM4\CopyCraft\Vendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use OM4\CopyCraft\Vendor\Http\Discovery\Exception\DiscoveryFailedException;
use OM4\CopyCraft\Vendor\Http\Discovery\Exception\NoCandidateFoundException;
...
abstract class ClassDiscovery
{
     ...
     * @var array
     */
    private static $strategies = [Strategy\CommonClassesStrategy::class, Strategy\CommonPsr17ClassesStrategy::class, Strategy\PuliBetaStrategy::class];
