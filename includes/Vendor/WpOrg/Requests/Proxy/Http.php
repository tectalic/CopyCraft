 ...
 * @since   1.6
 */
namespace OM4\CopyCraft\Vendor\WpOrg\Requests\Proxy;

use OM4\CopyCraft\Vendor\WpOrg\Requests\Exception\ArgumentCount;
use OM4\CopyCraft\Vendor\WpOrg\Requests\Exception\InvalidArgument;
use OM4\CopyCraft\Vendor\WpOrg\Requests\Hooks;
use OM4\CopyCraft\Vendor\WpOrg\Requests\Proxy;
/**
 * HTTP Proxy connection interface
 *
