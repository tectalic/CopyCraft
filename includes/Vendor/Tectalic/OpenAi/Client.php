...
use OM4\CopyCraft\Vendor\Http\Message\MultipartStream\MultipartStreamBuilder;
use OM4\CopyCraft\Vendor\Nyholm\Psr7\Factory\Psr17Factory;
use OM4\CopyCraft\Vendor\Psr\Http\Client\ClientExceptionInterface;
...
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Completions;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Edits;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Embeddings;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Files;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FilesContent;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FineTunes;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FineTunesCancel;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FineTunesEvents;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\ImagesEdits;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\ImagesGenerations;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\ImagesVariations;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Models;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Moderations;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\AbstractModel;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\AbstractModelCollection;
use Throwable;
/**
...
final class Client implements ClientInterface
{
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Completions($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Edits($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\ImagesGenerations($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\ImagesEdits($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\ImagesVariations($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Embeddings($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Files($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FilesContent($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FineTunes($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FineTunesCancel($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\FineTunesEvents($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Models($this);
    }
    /**
    ...
    {
        return new \OM4\CopyCraft\Vendor\Tectalic\OpenAi\Handlers\Moderations($this);
    }
    /**
    ...
    private function encodeJsonBody($body) : StreamInterface
    {
        ...
        if (\json_last_error() !== \JSON_ERROR_NONE || $body === \false) {
            throw new ClientException('Unable to encode body as JSON: ' . \json_last_error_msg());
        }
    ...
    private function encodeFormBody($body) : StreamInterface
    {
        ...
        if (!\is_array($body) && !\is_object($body)) {
            throw new ClientException('Unable to encode body. Could not serialize data.');
        }
    ...
    private function encodeMultipart(MultipartStreamBuilder $builder, $body) : StreamInterface
    {
        ...
        foreach (\get_object_vars($body) as $propertyName => $value) {
            ...
            try {
                ...
                throw new ClientException(\sprintf('Unable to convert %s value of %s::%s to a string.', \gettype($value), $modelClass, $propertyName));
            }
        }
     ...
     * @return RequestInterface
     */
    private function mergeRequestParts(RequestInterface $request, array $headers, array $params, $body) : RequestInterface
    {
        if (!empty($params)) {
            $uri = $request->getUri();
            $query = $uri->getQuery();
        ...
        $request = $request->withHeader('User-Agent', 'Tectalic OpenAI REST API Client/1.3.0');
        // Merge Headers.
        if (!empty($headers)) {
    ...
    public function sendRequest(RequestInterface $request) : ResponseInterface
    {
        try {
            ...
            throw new ClientException('Unexpected error. See previous exception for details.', 0, $e);
        } finally {
