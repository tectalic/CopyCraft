...
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\FineTunes\CreateRequest;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\FineTunes\CreateResponse;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\FineTunes\ListResponse;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\FineTunes\RetrieveResponse;
use Throwable;
final class FineTunes
{
    ...
    {
        $url = '/fine-tunes';
        $this->setRequest($this->client->post($url, \is_array($body) ? new CreateRequest($body) : $body, ['Content-Type' => 'application/json']));
     ...
     * @return self
     */
    public function retrieve($fineTuneId) : self
    {
        $url = \sprintf('/fine-tunes/%s', $fineTuneId);
        $this->setRequest($this->client->get($url, null, []));
