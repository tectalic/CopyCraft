...
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\FineTunesEvents\ListFineTuneResponse;
use Throwable;
final class FineTunesEvents
{
     ...
     * @return self
     */
    public function listFineTune($fineTuneId, $queryParams = []) : self
    {
        $url = \sprintf('/fine-tunes/%s/events', $fineTuneId);
        $this->setRequest($this->client->get($url, null, [], $queryParams));
        $this->modelType = ListFineTuneResponse::class;
        return $this;
    }
    /**
