...
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\ImagesEdits\CreateImageRequest;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\ImagesEdits\CreateImageResponse;
use Throwable;
final class ImagesEdits
{
    /** @var Client */
    private $client;
