...
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\ImagesVariations\CreateImageRequest;
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\ImagesVariations\CreateImageResponse;
use Throwable;
final class ImagesVariations
{
    /** @var Client */
    private $client;
     ...
     *
     * @param CreateImageRequest|array $body
     *
     * @api
     * @return self
     */
    public function createImage($body) : self
    {
        $url = '/images/variations';
        $this->setRequest($this->client->post($url, \is_array($body) ? new CreateImageRequest($body) : $body, ['Content-Type' => 'multipart/form-data']));
        $this->modelType = CreateImageResponse::class;
        return $this;
    }
    /**
