...
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\FilesContent\DownloadResponse;
use Throwable;
final class FilesContent
{
    /** @var Client */
    private $client;
     ...
     * @return self
     */
    public function download($fileId) : self
    {
        $url = \sprintf('/files/%s/content', $fileId);
        $this->setRequest($this->client->get($url, null, []));
        $this->modelType = DownloadResponse::class;
        return $this;
    }
    /**
