...
use OM4\CopyCraft\Vendor\Tectalic\OpenAi\Models\FineTunesCancel\CancelFineTuneResponse;
use Throwable;
final class FineTunesCancel
{
     ...
     * @return self
     */
    public function cancelFineTune($fineTuneId) : self
    {
        $url = \sprintf('/fine-tunes/%s/cancel', $fineTuneId);
        $this->setRequest($this->client->post($url, null, []));
        $this->modelType = CancelFineTuneResponse::class;
        return $this;
    }
    /**
