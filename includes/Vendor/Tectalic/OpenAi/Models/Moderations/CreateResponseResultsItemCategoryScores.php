...
final class CreateResponseResultsItemCategoryScores extends AbstractModel
{
     ...
     */
    protected const MAPPED = ['hateThreatening' => 'hate/threatening', 'selfHarm' => 'self-harm', 'sexualMinors' => 'sexual/minors', 'violenceGraphic' => 'violence/graphic'];
    /**
     * List of required property names.
     *
     * These properties must all be set when this Model is instantiated.
     */
    protected const REQUIRED = ['hate', 'hateThreatening', 'selfHarm', 'sexual', 'sexualMinors', 'violence', 'violenceGraphic'];
    /** @var float|int */
    public $hate;
    /** @var float|int */
